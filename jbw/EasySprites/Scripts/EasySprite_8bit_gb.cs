////////////////////////////////////////////////////////////////
/// EASY 2D SPRITES - 8 Bits GB  -1.2- by VETASOFT 2014
/////////////////////////////////////////////////////////////////
...
[ExecuteInEditMode]
[AddComponentMenu ("Easy Sprites 2D/8 Bits - GB")]
public class EasySprite_8bit_gb : MonoBehaviour {
	...
	void Start () 
	{
		tempMaterial = new Material(Shader.Find("EasySprite2D/8BitGB_EasyS2D"));
